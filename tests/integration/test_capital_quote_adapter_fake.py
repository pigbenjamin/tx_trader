...
class Fake:
    ...
    def co_initialize(self):
        self.record("co_initialize")

    def initialize(self, path):
        self.record("initialize", path)

    def register_events(self, sink):
        self.record("register_events")
        self.sink = sink

    def login(self, account, password):
        self.record("login", account, password)
        return 0

    def enter_monitor(self):
        self.record("enter_monitor")
        return 0

    def leave_monitor(self):
        self.record("leave_monitor")
        return 0

    def request_quotes(self, value):
        self.record("request_quotes", value)
        return 0
    ...
    def cancel_quotes(self, value):
        self.record("cancel_quotes", value)
        return 0

    def cancel_ticks(self, value):
        self.record("cancel_ticks", value)
        return 0
    ...
    def release_events(self):
        self.record("release_events")

    def release_objects(self):
        self.record("release_objects")

    def co_uninitialize(self):
        self.record("co_uninitialize")
